...
{
    public sealed class BetfairClient : IClient
    {
        ...
        public BetfairClient(Exchange exchange = Exchange.UK, string appKey = "kPuMpSRRkyzIFodA", Action preNetworkRequest = null, WebProxy proxy = null)
        {
        ...
        //Используется BetFairClientSync
        ...
        public bool Login(string p12CertificateLocation, string p12CertificatePassword, string username, string password)
        {
            ...
            {
                var jsonResponse = BetfairNG.JsonConvert.Deserialize<LoginResponse>(reader.ReadToEnd()); //Newtonsoft.JsonConvert ?
    ...
    public class BetfairServerException : System.Exception
    {
        ...
        public static BetfairServerException ToClientException(BetfairNG.Data.Exceptions.Exception ex)
        {
